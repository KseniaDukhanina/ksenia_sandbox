...
В разделе  "Пример настройки процесса" размещено руководство, описывающее создание процесса в системе Citeck ECOS.
...
Информация по установке Citeck ECOS Community
